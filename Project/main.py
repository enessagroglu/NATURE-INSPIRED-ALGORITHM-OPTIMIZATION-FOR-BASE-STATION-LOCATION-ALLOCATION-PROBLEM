...
def simulation(choice,max_generations=500, max_stagnant_generations=500, mutation_rate=0.392, tournament_size=4, coverage_radius=5, max_demand_per_station=100):
