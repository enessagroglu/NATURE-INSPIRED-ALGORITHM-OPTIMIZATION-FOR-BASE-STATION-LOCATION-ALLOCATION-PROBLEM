...
def create_first_population():
    #basibuyuk
    basibuyuk_path = r"D:\GraduationProject\NATURE-INSPIRED-ALGORITHM-OPTIMIZATION-FOR-BASE-STATION-LOCATION-ALLOCATION-PROBLEM\Project\data\basibuyuk.json"
    basibuyuk_output_path = r"D:\GraduationProject\NATURE-INSPIRED-ALGORITHM-OPTIMIZATION-FOR-BASE-STATION-LOCATION-ALLOCATION-PROBLEM\Project\data\basibuyuk_initial_population.json"
    generate_initial_population(basibuyuk_path, basibuyuk_output_path)

    #tepeustu
    tepeustu_path = r"D:\GraduationProject\NATURE-INSPIRED-ALGORITHM-OPTIMIZATION-FOR-BASE-STATION-LOCATION-ALLOCATION-PROBLEM\Project\data\tepeustu.json"
    tepeustu_output_path = r"D:\GraduationProject\NATURE-INSPIRED-ALGORITHM-OPTIMIZATION-FOR-BASE-STATION-LOCATION-ALLOCATION-PROBLEM\Project\data\tepeustu_initial_population.json"
    generate_initial_population(tepeustu_path, tepeustu_output_path)

    #resadiye
    resadiye_path = r"D:\GraduationProject\NATURE-INSPIRED-ALGORITHM-OPTIMIZATION-FOR-BASE-STATION-LOCATION-ALLOCATION-PROBLEM\Project\data\resadiye.json"
    resadiye_output_path = r"D:\GraduationProject\NATURE-INSPIRED-ALGORITHM-OPTIMIZATION-FOR-BASE-STATION-LOCATION-ALLOCATION-PROBLEM\Project\data\resadiye_initial_population.json"
